...
It takes just a few minutes to build a subgraph that indexes data on Soneium. Follow these three steps to get started:
...
### Select theb correct network name in the CLI
Choose the chain name which is <mark>soneium-testnet</mark> in this case from the cli 

### Provide other information for the subgraph
